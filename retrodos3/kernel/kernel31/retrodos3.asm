...
; ----------------------------------------------------------------------------
; Last Update: 22/01/2024 (BugFix) - (Previous: 28/08/2023)
; ----------------------------------------------------------------------------
...
CON$EXIT:
		...
		jmp	EXIT ; 26/09/2019 - Retro DOS v3.1
...
Install_Ret:
		...
		mov	word [DI],-1 ; 05/07/2019 - Retro DOS v3.1
		retn
...
;BPB_Table equ SYSINIT_START + 169Eh  ; (BPBTable offset in sysinit2.asm)
;;BPB_Table equ SYSINIT_START + 1C34h
;BPBSIZ	  equ 25  ; Retro DOS v3.0 (02/06/2018)	

; 22/11/2022
BPB_Table equ SYSINIT_START + 1696h  ; (BPBTable offset in sysinit2.asm)
BPBSIZ	  equ 25  ; Retro DOS v3.0 (02/06/2018)
...
sysinit_code_start:
		; 22/11/2022
		; 09/07/2019 ('sysinit2.asm' last modification)
		incbin	'SYSINIT2.BIN' ; Retro DOS 3.1 - MSDOS 3.3 'SYSINIT'
sysinit_code_end:
		db 90h
...
MSDOS_BIN_OFFSET:  ; this offset must be paragraph aligned
		...
		; 16/01/2024 (BugFix)
		; 22/11/2022 (BugFix)
		; 24/07/2019 ('msdos3.asm' last modification)
