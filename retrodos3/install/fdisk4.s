; ****************************************************************************
; FDISK4.ASM (FDISK4.COM) - TRDOS 386 Hard Disk Partitioning Utility
; 						      (for MSDOS/WINDOWS)
; ****************************************************************************
...
; ----------------------------------------------------------------------------
; Derived from 'fdisk3.s' (FDISK3.COM) source code by Erdogan Tan
; (05/11/2020)
;
; Derived from 'hdimage.s' (HDIMAGE.COM) source code by Erdogan Tan
; (04/11/2020)
; ****************************************************************************
; nasm fdisk4.s -l fdisk4.lst -o FDISK4.COM -Z error.txt
...
TrDOS_Welcome:
	...
	db	0Dh, 0Ah
	db	"v2.0.210321 (c) Erdogan TAN 2021"
	db	0Dh,0Ah
	db	0Dh,0Ah
	db	0
TrDOS_Usage:
	db	'Usage: fdisk4 <hard disk name> '
	db	0Dh, 0Ah
	db	0Dh, 0Ah
	db	"Hard disk names: "
	db	0Dh, 0Ah
