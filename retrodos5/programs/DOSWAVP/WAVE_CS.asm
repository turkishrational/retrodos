...
loadWAVEHeaders_loadWAV:
	...
	call loadData
	jnz invalid_waveheader

	call checkWAVEHeader
	jnz invalid_waveheader

	cmp [word ptr WAVE_AudioFormat], 1 ;;; Offset 20, must be 1 (= PCM)
	je short loadWAVEHeaders_return

	push offset string_riffheader_improper
	jmp  error_msg 
