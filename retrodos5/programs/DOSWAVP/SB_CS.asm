...
ProgramDMA_PageNumber	equ	[bp-4]
...
ProgramDMA_DMAC2:
	...
	;; from the beginning of a 128kb page
	;; so it must divided by two first.

	mov dx, ProgramDMA_PageNumber
	shr dx, 1
	mov ax, ProgramDMA_LinearAddr
	rcr ax, 1
...
ProgramDSP_StartTransfer:
	mov ax, ProgramDSP_BPS
	cmp ax, 16
	je ProgramDSP_Transfer16Bit

ProgramDSP_Transfer8Bit:
	mov ax, ProgramDSP_TransferLen
	jmp ProgramDSP_Transfer

ProgramDSP_Transfer16Bit:
	mov ax, ProgramDSP_TransferLen
	shr ax, 1
