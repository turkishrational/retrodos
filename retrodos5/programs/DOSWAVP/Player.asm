...
; Modification: Erdogan Tan - 31/10/2024
; --------------------------------------
...
string_help                 db    "Welcome to DosPlayer!", 10, 10, 13
                            ...
                            db    "Modification: Erdogan Tan - 02/11/2024", 0   					
...
string_riffheader_improper  db    "ERROR: Improper WAV file format (not PCM) for this program.", "$"
...
Visualization_LastTimer  dw    0
		...
		command db 0
		; 02/11/2024 - Erdogan Tan
		align 2	; even buff addr is necessary for 16bit (DMA) playing		
...
DATA                db    48000 dup(?) ;; Actual sound data.
...
Player_getFileHandle:
    ...
    cmp [byte ptr IsInSplash], 0
    jna wav_file_open_error   

    mov [byte ptr IsInSplash], 0     
    jmp Player_Template
...
Player_CheckLastTransfer:
    ...
    ;; AX != SubBufferLength: LastTransfer.
    ...
    jz Player_CheckLastTransfer_EOF
...
Player_MainLoop:
    ;; Most of the program execution is here
