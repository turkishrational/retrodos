...
#define id x
	...
	set_cmt	(0XC5FA,	"[es:bp+DPB.LAST_CLUSTER+2]",	0);
	create_insn	(x=0XC5FE);
	op_plain_offset	(x,	0,	0);
	op_plain_offset	(x,	128,	0);
	set_cmt	(0XC602,	"[es:bp+DPB.LAST_CLUSTER]",	0);
	set_cmt	(0XC608,	"0",	0);
...
static Functions_0(void) {
	...
	set_name(0X8178, "EOFER", SN_LOCAL);
	...
	set_name(0X8651, "WRTEOF4", SN_LOCAL);
