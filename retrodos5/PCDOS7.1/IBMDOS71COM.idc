...
#define id x
	...
	create_byte	(0XAA7);
	make_array	(0XAA7,	0XE);
	create_word	(0XAB5);
	set_name	(0XAB5,	"ENTLAST_PREV");
	create_byte	(0XAB7);
	make_array	(0XAB7,	0X24);
	create_byte	(0XADB);
...
#define id x
	...
	set_cmt	(0X9D61,	"BUGGY ! Erdogan Tan - 31/01/2024\n(Windows ME 'RELEASE' code is correct)\n((Windows ME IO.SYS - BIOSCODE:C2BBh))",	0);
...
#define id x
	...
	op_hex		(x,	1);
	set_cmt	(0XC20B,	"bit 15 = 1 -> remote file",	0);
	...
	op_plain_offset	(x,	0,	0);
	op_plain_offset	(x,	128,	0);
	set_cmt	(0XC246,	"error_invalid_parameter",	0);
...
static Functions_0(void) {
	...
	set_name(0XC24D, "OpenCleanJ", SN_LOCAL);
