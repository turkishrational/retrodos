...
#define id x
	...
	set_cmt	(0X51B5,	"bit 4-6 of DBP.EXT_FLAGS must be 0",	0);
	...
	set_cmt	(0X6074,	"word [ES:DI+SF_ENTRY.sf_position],0",	0);
	set_cmt	(0X6079,	"word [ES:DI+SF_ENTRY.sf_position+2],0",	0);
	...
	op_hex		(x,	1);
	create_insn	(0X6BBC);
	set_cmt	(0X6BC1,	"[DI+BUFFINFO.buf_flags],buf_dirty",	0);
	...
	set_cmt	(0X6F5B,	"hw of cluster number",	0);
	...
	set_cmt	(0X7427,	"sectors per clust = sectors per clust * 2",	0);
...
#define id x
	...
	op_plain_offset	(x,	0,	0);
	op_plain_offset	(x,	128,	0);
	set_cmt	(0X9814,	"[ES:DI+SF_ENTRY.sf_firclus]",	0);
	...
	op_plain_offset	(x,	0,	0);
	op_plain_offset	(x,	128,	0);
	set_cmt	(0X984A,	"[ES:DI+SF_ENTRY.sf_chain+2]",	0);
	create_insn	(x=0X984A);
	op_hex		(x,	1);
	create_insn	(x=0X984E);
	op_plain_offset	(x,	0,	0);
	op_plain_offset	(x,	128,	0);
	set_cmt	(0X9852,	"[ES:DI+SF_ENTRY.sf_chain]",	0);
	...
	op_plain_offset	(x,	0,	0);
	op_plain_offset	(x,	128,	0);
	set_cmt	(0X9D35,	"Was putting EOF mark",	0);
	...
	set_cmt	(0XA40F,	"12 or 16 bit compare",	0);
	...
	op_plain_offset	(x,	0,	0);
	op_plain_offset	(x,	128,	0);
	set_cmt	(0XA5B9,	"[es:bp+DBP.FAT_SIZE]",	0);
	create_insn	(0XA5B9);
	...
	op_plain_offset	(x,	0,	0);
	op_plain_offset	(x,	128,	0);
	set_name	(0XAC2A,	"flushbuf_retn");
	set_cmt	(0XAC2B,	"-1",	0);
	create_insn	(0XAC2B);
	set_name	(0XAC2B,	"FLUSHBUF");
	create_insn	(x=0XAC2F);
	op_dec		(x,	1);
	set_cmt	(0XAC32,	"[ss:bx+drv_flags-1],0F7h\nclear bit 3",	0);
...
static Functions_0(void) {
	...
	add_func    (0X7723,0X7859);
	set_func_flags(0X7723,0x401);
	...
	set_name(0X790D, "_BadRet", SN_LOCAL);
	...
	set_name(0X7A99, "lrd_chk_fat32", SN_LOCAL);
	set_name(0X7AB2, "NOPATH", SN_LOCAL);
	set_name(0X7AB8, "NOTDIRPATHPOP", SN_LOCAL);
	set_name(0X7ABA, "NOTDIRPATHPOP2", SN_LOCAL);
	set_name(0X7ABB, "NOTDIRPATH", SN_LOCAL);
	set_name(0X7ABE, "rmdir_get_buf", SN_LOCAL);
	...
	set_name(0XA430, "IsEOF_other2", SN_LOCAL);
	...
	set_name(0XAC68, "flshbuf_3", SN_LOCAL);
