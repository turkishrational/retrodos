; ****************************************************************************
; 'rd5hdi16.s' - Retro DOS v5 Hard Disk Image (FAT16 FS) Formatting Utility
; 					 	        (for MSDOS/WINDOWS)
; ****************************************************************************
; Last Update: 04/05/2024
; ----------------------------------------------------------------------------
; Beginning: 04/05/2024
; ----------------------------------------------------------------------------
; Assembler: NASM version 2.15
; ----------------------------------------------------------------------------
; Modified from 'fat16hdi.s'(FAT16HDI.COM) source code by Erdogan Tan
; (28/10/2023) - Retro DOS v3-v4 hard disk (FAT16) image formatting utility -
; ****************************************************************************
; nasm rd5hdi16.s -l rd5hdi16.txt -o RD5HDI16.COM
...
RETRODOS_FAT16_hd_bs: 
	;;incbin 'RD3HDBS.BIN'
	;; 28/10/2023
	;incbin	'RD4HDBS.BIN'	; BS Last Update: 24/10/2023
	; 04/05/2024
...
db  "RETRO DOS v5.0 Hard Disk Image Utility by Erdogan Tan (2018-2024)               "
db  "                                                                                "
db  "                                                                                "
...
RetroDOS_Welcome:
	db	0Dh, 0Ah
	db	'Retro DOS v5 Fixed Disk Image (FAT16 FS) Format Utility'
	db	0Dh, 0Ah
	db	"FAT16HDI v5.0.240504 (c) Erdogan TAN 2018-2024"
	db	0Dh,0Ah
	db	0Dh,0Ah
	db	'Usage: rd5hdi16 <image file name> '
	db	0
