...
loc_95E9:                               ; ...
                ...
                pop     ax
; END OF FUNCTION CHUNK FOR MakeNode
; [00000001 BYTES: COLLAPSED FUNCTION nullsub_20. PRESS CTRL-NUMPAD+ TO EXPAND]
...
NO_DEALLOC:                             ; ...
                ...
                jnz     short relblks_ifc ; BUGGY ! Erdogan Tan - 31/01/2024
                                        ; (Windows ME 'RELEASE' code is correct)
                                        ; ((Windows ME IO.SYS - BIOSCODE:C2BBh))
...
loc_AB8B:                               ; ...
                ...
                cld
                cmp     ss:DDMOVE, 0
                jz      short near ptr loc_ABAA+1 ; rep movsw (skip 32bit prefix)
                shr     cx, 1
...
loc_C1F6:                               ; ...
                ...
                jz      short loc_C20E
                and     al, 7Fh
                mov     cx, 1000h       ; bit 15 = 1 -> remote file
...
LOCK_VIOLATION  proc near               ; ...
                ...
                jnz     short lockv_1
                mov     dx, es:[bp+2Bh] ; [es:bp+DPB.LAST_CLUSTER+2]
                mov     ds:HIGH_SECTOR, dx
                mov     dx, es:[bp+29h] ; [es:bp+DPB.LAST_CLUSTER]
                jmp     short lockv_2
; ---------------------------------------------------------------------------
