...
#define id x
	...
	create_byte	(0X403E);
	make_array	(0X403E,	0X20);
	create_strlit	(0X405E,	0X40BD);
	set_name	(0X405E,	"a_0123456789?@a");
	create_byte	(x=0X40BD);
	op_dec		(x,	0);
	create_strlit	(0X40BE,	0X40E4);
	set_name	(0X40BE,	"aCueaaaaceeeiii");
...
#define id x
	...
	set_name	(0X8B55,	"_set_user_cf");
	set_cmt	(0X8B58,	"[SI+user_env.user_F],f_Carry",	0);
	create_insn	(x=0X8B58);
	op_hex		(x,	1);
	set_cmt	(0X8B5D,	"[SI+user_env.user_AX]",	0);
	create_insn	(0X8B60);
...
static Functions_0(void) {
	...
	add_func    (0XD30C,0XD30D);
	set_func_flags(0XD30C,0x4400);
	set_frame_size(0XD30C, 0, 0, 0);
	...
	add_func    (0XDA1A,0XDBA5);
	set_func_flags(0XDA1A,0x4402);
	...
	add_func    (0XE18B,0XE18E);
	set_func_flags(0XE18B,0x400);
	add_func    (0XE18E,0XE1A2);
	set_func_flags(0XE18E,0x4400);
	set_frame_size(0XE18E, 0, 0, 0);
	...
	add_func    (0XEE82,0XEE85);
	set_func_flags(0XEE82,0x4480);
	set_frame_size(0XEE82, 0X4, 0, 0);
	...
	add_func    (0XF10A,0XF10C);
	set_func_flags(0XF10A,0x400);
	add_func    (0XF10C,0XF112);
	set_func_flags(0XF10C,0x4400);
	set_frame_size(0XF10C, 0, 0, 0);
	...
	add_func    (0XF137,0XF139);
	set_func_flags(0XF137,0x400);
	add_func    (0XF139,0XF20A);
	set_func_flags(0XF139,0x400);
...
static SegRegs(void) {
	...
	split_sreg_range(0XE54B,"es",0XFFFFFFFFFFFFFFFF,3);
	...
	split_sreg_range(0X114AD,"es",0XFFFFFFFFFFFFFFFF,3);
	split_sreg_range(0X114C1,"es",0XFFFFFFFFFFFFFFFF,3);
	split_sreg_range(0X114E5,"es",0XFFFFFFFFFFFFFFFF,3);
	split_sreg_range(0X11514,"es",0XFFFFFFFFFFFFFFFF,3);
	split_sreg_range(0X11527,"es",0XFFFFFFFFFFFFFFFF,3);
	split_sreg_range(0X1154B,"es",0XF000000000000000,3);
	split_sreg_range(0X11557,"es",0XF000000000000000,3);
	split_sreg_range(0X11569,"es",0XEFFFFFFFFFFFFFFF,3);
	split_sreg_range(0X1158E,"es",0XE000000000000000,3);
	split_sreg_range(0X1159B,"es",0XE000000000000001,3);
	split_sreg_range(0X115AD,"es",0XDFFFFFFFFFFFFFFF,3);
	split_sreg_range(0X115D1,"es",0XD000000000000000,3);
	...
	split_sreg_range(0XD8E3,"ds",0XFFFFFFFFFFFFFFFF,3);
	...
	split_sreg_range(0X114AB,"ds",0XFFFFFFFFFFFFFFFF,3);
	split_sreg_range(0X114DF,"ds",0,3);
	split_sreg_range(0X114E4,"ds",0XFFFFFFFFFFFFFFFF,3);
	split_sreg_range(0X11512,"ds",0XFFFFFFFFFFFFFFFF,3);
	split_sreg_range(0X1153A,"ds",0XF000000000000001,3);
	split_sreg_range(0X11555,"ds",0XF000000000000000,3);
	split_sreg_range(0X1157C,"ds",0XE000000000000002,3);
	split_sreg_range(0X11599,"ds",0XE000000000000001,3);
	split_sreg_range(0X115C0,"ds",0XD000000000000003,3);
