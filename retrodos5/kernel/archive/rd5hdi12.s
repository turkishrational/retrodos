; ****************************************************************************
; 'rd5hdi12.s' - Retro DOS v5 Hard Disk Image (FAT12 FS) Formatting Utility
; 					 	        (for MSDOS/WINDOWS)
; ****************************************************************************
...
; ----------------------------------------------------------------------------
; Modified from 'fat12hdi.s'(FAT12HDI.COM) source code by Erdogan Tan
; (28/10/2023) - Retro DOS v2-v4 hard disk (FAT12) image formatting utility -
; ****************************************************************************
; nasm rd5hdi12.s -l rd5hdi12.txt -o RD5HDI12.COM
...
RetroDOS_Welcome:
	db	0Dh, 0Ah
	db	'Retro DOS v5 Fixed Disk Image (FAT12 FS) Format Utility'
	db	0Dh, 0Ah
	db	"FAT12HDI v5.0.240504 (c) Erdogan TAN 2018-2024"
	db	0Dh,0Ah
	db	0Dh,0Ah
	db	'Usage: rd5hdi12 <image file name> '
	db	0
