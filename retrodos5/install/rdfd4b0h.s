; ****************************************************************************
; RDFD4B0H.ASM (RDFD4B0H.COM) - Retro DOS v5 Floppy Disk Boot Sector Utility
; 							 (for MSDOS/WINDOWS)
; ----------------------------------------------------------------------------
...
; ----------------------------------------------------------------------------
; Modified from 'rdfd1200.s'(RDFD1200.COM) src code by Erdogan Tan, 25/10/2023
; ****************************************************************************
; assembling: nasm rdfd4b0h.s -l rdfd4b0h.txt -o RDFD4B0H.COM -Z error.txt
...
RetroDOS_Welcome:
	db	0Dh, 0Ah
	db	'Retro DOS v5 - 1.2 MB Floppy Disk Boot Sector Update Utility'
	db	0Dh, 0Ah
	;db	"v1.0.231025  (c) Erdogan TAN 2023"
	db	"RDFDBOOT v2.0.240420  (c) Erdogan TAN 2023-2024"
	db	0Dh,0Ah
	db	0Dh,0Ah
	db	'Usage: rdfd4b0h a: (or b:)'
	db	0
...
incbin	"FDBS4B0H.BIN"	; Kernel file: 'PCDOS.SYS' ; 20/04/2024
