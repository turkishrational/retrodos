; ****************************************************************************
; FDBS168H.ASM - Retro DOS v5.0 - FAT12 FD BOOT SECTOR (5 1/4", 360K diskette)
; ----------------------------------------------------------------------------
; Last Update: 20/04/2024
; ----------------------------------------------------------------------------
; Beginning: 20/04/2024
; ----------------------------------------------------------------------------
; Assembler: NASM version 2.15 (fdbs168h.s)
; ----------------------------------------------------------------------------
; Retro DOS Operating System Project by ERDOGAN TAN (Beginning: 04/02/2018)
; ----------------------------------------------------------------------------
; Modified from Retro DOS v2.0-v4.2 boot sector code, 'fdbs360.s', 25/10/2023
; ****************************************************************************

; fdbs360.s - 25/10/2023
...
BS_02:				
		call	fd_read_1
		jc	short BS_05		; Disk read error message						; (DL = 0)
