; ****************************************************************************
; RFDIB40H.ASM (RFDIB40H.COM) - Retro DOS v5.0 Floppy Disk Image Formatting
;						  Utility for MSDOS/WINDOWS
; ----------------------------------------------------------------------------
; Only for 2.88MB (3.5") Floppy Disks
; ****************************************************************************
...
; ----------------------------------------------------------------------------
; Modified from 'rfdi2880.s'(RFDI2880.COM) src code by Erdogan Tan, 25/10/2023
; ****************************************************************************
; nasm rfdib40h.s -l rfdib40h.txt -o RFDIB40H.COM

bsDriveNumber   equ RETRODOS_FAT12_FDBS + 36
bsVolumeID      equ RETRODOS_FAT12_FDBS + 39
bsVolumeLabel   equ RETRODOS_FAT12_FDBS + 43

; rfdi2880.s - Retro DOS v4.0-v4.2 - 25/10/2023
...
R_14:
	...
	cmp	word [SI], 2Dh
	jne	short R_19
	or	ax, ax	; 2.88 MB floppy disk image (2D0000h bytes)
	jnz	short R_19
...
R_22:
	...
	jc	R_29
	inc	ax
 	cmp	ax, 33 ; 19+15 = 34 (15 sectors, 240 entries)
	jna	short R_22
...
RETRODOS_FAT12_FDBS:
	...
	incbin 'FDBSB40H.BIN'	; 20/04/2024
...
RetroDOS_Welcome:
	db	0Dh, 0Ah
	db	'RETRO DOS v5 2.88MB FAT12 Floppy Disk Image Format Utility'
	db	0Dh, 0Ah
	;db	"v3.0.231025  (c) Erdogan TAN 2018-2023"
	db	"RDFDIMAGE v4.0.240420  (c) Erdogan TAN 2018-2024"
	db	0Dh,0Ah
	db	0Dh,0Ah
	db	'Usage: rfdib40h <image file name> '
	db	0
...
msg_inv_image_file:
	...
	db	"(File size must be 2949120 bytes) !"
	db	0Dh, 0Ah, 0  
