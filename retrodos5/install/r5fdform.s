; ****************************************************************************
; R5FDFORM.ASM (R5FDFORM.COM) - Retro DOS v5 Floppy Disk Formatting Utility
; 							   (for MSDOS/WINDOWS)
; ----------------------------------------------------------------------------
...
; ----------------------------------------------------------------------------
; Modified from 'rdfdform.s'(RDFDFORM.COM) source code by Erdogan Tan
; (28/10/2023) - RETRODOS v4 floppy disk formatting utility -
; ****************************************************************************
; nasm r5fdform.s -l r5fdform.txt -o R5FDFORM.COM
...
RD_Welcome:
	db	0Dh, 0Ah
	db	'Retro DOS v5 FAT12 Floppy Disk Formatting Utility '
	db	0Dh, 0Ah
	;db	'v1.0.231028  (c) Erdogan TAN 2023 '
	db	'FDFORMAT v2.0.240420  (c) Erdogan TAN 2023-2024 '
	db	0Dh,0Ah
	db	0Dh,0Ah
	db	'Usage: r5fdform <drive> ', 0Dh, 0Ah
	db	0Dh, 0Ah
	db	' Example: r5fdform A: ', 0Dh, 0Ah
	db	0Dh, 0Ah
	db	'Optional: r5fdform -type(x) <drive> ', 0Dh, 0Ah
	db	0Dh, 0Ah
	db	' Example: r5fdform -3 A:  (720KB soft format) '
	db	0Dh, 0Ah
	db	'          r5fdform -3x A: (720KB hard format) '
	db	0Dh, 0Ah
	db	0Dh, 0Ah
...
Msg_Writing_Boot_Sector:
	...
	; 20/04/2024
	db	"Writing Retro DOS v5 boot sector...", 0
...
RD_FAT12_fd_bs:
	;incbin 'FDBS1440.BIN' ; 25/10/2023 (Kernel: MSDOS.SYS)
	;incbin 'FDBS2880.BIN' ; 25/10/2023 (Kernel: MSDOS.SYS)
	; 20/04/2024
	incbin 'FDBS5A0H.BIN' ; Kernel: PCDOS.SYS
	incbin 'FDBSB40H.BIN' ; Kernel: PCDOS.SYS
