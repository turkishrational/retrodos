; ****************************************************************************
; FDBSB40H.ASM - Retro DOS v5.0 - FAT12 FD BOOT SECTOR (3 1/2", 2.88 MB)
; ----------------------------------------------------------------------------
; Last Update: 20/04/2024
; ----------------------------------------------------------------------------
; Beginning: 20/04/2024
; ----------------------------------------------------------------------------
; Assembler: NASM version 2.15 (fdbsb40h.s)
; ----------------------------------------------------------------------------
; Retro DOS Operating System Project by ERDOGAN TAN (Beginning: 04/02/2018)
; ----------------------------------------------------------------------------
; Modified from Retro DOS v2.0-v4.2 boot sector code, 'fdbs2880.s', 25/10/2023
; ****************************************************************************

; fdbs2880.s - 25/10/2023
...
BS_01:          
		...
		; 24/10/2023
		; check for 2.88MB only
		; (sectors per cluster value must be 2)
		; ((it is necessary for accessing all of 5760 sectors))
		;
		;cmp	byte [bsSecPerClust], 2	; !*+
		;jne	short BS_04_ERR	; write "replace disk .." message
...
BS_02:
		...
		;;mov	cx, 15			; Root Directory Sectors
...
BS_07:
		...
		mov	dh, [bsMedia]
		mov	ax, [bsSectors] ; 5760 sectors, 2.88 MB
