; ****************************************************************************
; FDBS1200.ASM - Retro DOS v2.0 - FAT12 FD BOOT SECTOR (5 1/4", 1.2 MB)
; ----------------------------------------------------------------------------
; Last Update: 27/03/2018 (Retro DOS 2.0) -different boot sector code-
; Last Update: 23/02/2018 (Retro DOS 1.0)
; ----------------------------------------------------------------------------
; Beginning: 12/02/2018 (Retro DOS 1.0)
; ----------------------------------------------------------------------------
; Assembler: NASM version 2.11 (fdbs1200.s)
; ----------------------------------------------------------------------------
...
BS_06:
		...
		mov	dh, [bsMedia]
		mov	ax, [bsSectors] ; 2400 sectors, 1.2 MB
...
BS_12:
		...
		;add	ax, 29                  ; Beginning sector of Data
BS_13:
                add	ax, [bsDataStart]
		call    fd_read
                jc      short BS_15
