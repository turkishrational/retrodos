; ****************************************************************************
; FDBS720.ASM - Retro DOS v2.0 - FAT12 FD BOOT SECTOR (3 1/2", 720K diskette)
; ----------------------------------------------------------------------------
...
; ----------------------------------------------------------------------------
; Assembler: NASM version 2.11 (fdbs720.s)
; ----------------------------------------------------------------------------
...
BS_06:
		...
		mov	dh, [bsMedia]
		mov	ax, [bsSectors] ; 1440 sectors, 720 KB
...
BS_12:
		...
		;add	ax, 14                  ; Beginning sector of Data
BS_13:
                add	ax, [bsDataStart]
		call    fd_read
                jc      short BS_15
