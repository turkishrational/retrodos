; ****************************************************************************
; R4HDBOOT.ASM (R4HDBOOT.COM) - Retro DOS v4 Hard Disk Boot Sector Utility
; 					 	          (for MSDOS/WINDOWS)
; ****************************************************************************
; Last Update: 25/10/2023 (Previous: 15/09/2022, R3HDBOOT.ASM)
; ----------------------------------------------------------------------------
...
RetroDOS_Welcome:
	db	0Dh, 0Ah
	db	'Retro DOS v4.0 Fixed Disk Boot Sector Update Utility'
	db	0Dh, 0Ah
	db	"v1.0.231025  (c) Erdogan TAN 2018-2023"
	db	0Dh,0Ah
	db	0Dh,0Ah
	db	'Usage: r4hdboot c: (or d:)'
	db	0
