; ****************************************************************************
; EPFORMAT.ASM (EPFORMAT.COM) - Retro DOS v4 Hard Disk Formatting Utility
; (RDEPFORM.S - RDEPFORM.COM)
; ----------------------------------------------------------------------------
; Extended DOS Partition (FAT File System) Format Utility for Retro DOS v4 OS.
; ----------------------------------------------------------------------------
; Last Update: 15/07/2024 (Previous: 04/05/2024)
; ----------------------------------------------------------------------------
; Beginning: 28/10/2023
; ----------------------------------------------------------------------------
; Assembler: NASM version 2.15 (rdepform.s)
; ----------------------------------------------------------------------------
; Modified from 'epformat.s'(EPFORMAT.COM) source code by Erdogan Tan
; (28/10/2023) - TRDOS 386 hard disk extended partition formatting utility -
; ----------------------------------------------------------------------------
...
RD_Welcome:
	...
	db 0Dh, 0Ah
	db 0Dh, 0Ah
	db 'v1.1.240715 (c) Erdogan TAN 2020-2024'
	db 0Dh,0Ah
	db 0Dh,0Ah
